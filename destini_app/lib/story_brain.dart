...
class StoryBrain {
  ...
  List<Story> _storyData = [
    Story(
        ...
        image: 'images/story_0_image.png'),
    Story(
        storyTitle: 'He nods slowly, unphased by the question.',
        choice1: 'At least he\'s honest. I\'ll climb in.',
        choice2: 'Wait, I know how to change a tire.',
        image: 'images/story_1_image.jpg'),
    Story(
        storyTitle:
    ...
    Story(
        ...
        choice1: 'Restart',
        choice2: '',
        image: 'images/story_4_image.jpg'),
    Story(
        storyTitle:
            'You bond with the murderer while crooning verses of "Can you feel the love tonight". He drops you off at the next town. Before you go he asks you if you know any good places to dump bodies. You reply: "Try the pier".',
        choice1: 'Restart',
        choice2: '',
        image: 'images/story_5_image.jpg')
  ];

  String getStory() {
    return this._storyData[storyNumber].getTitle();
  }

  String getImage() {
    return this._storyData[storyNumber].getImage();
  }

  String getChoice1() {
    return this._storyData[storyNumber].getChoice1();
  }

  String getChoice2() {
    return this._storyData[storyNumber].getChoice2();
  }

  void nextStory({int choice = 1}) {
    if (storyNumber == 0) {
      storyNumber = [2, 1][choice - 1];
      return;
    }
    if (storyNumber == 1) {
      storyNumber = [2, 3][choice - 1];
      return;
    }
    if (storyNumber == 2) {
      storyNumber = [5, 4][choice - 1];
      return;
    }
    storyNumber = 0;
  }
